...
import com.droidcon.scientistcodelab.dictionary.DictionaryExperiment
import com.droidcon.scientistcodelab.dictionary.DictionaryScreen
import com.droidcon.scientistcodelab.registration.EmailValidatorExperiment
...
class MainActivity : ComponentActivity() {
    ...
    private val getFollowersExperiment = GetFollowersExperiment(repository)
    private val dictionaryExperiment = DictionaryExperiment(
        ScientistCodelabApplication.instance.dictionaryScenario.sharedPrefDataSource,
        ScientistCodelabApplication.instance.dictionaryScenario.roomDbDataSource
    )
    private val emailValidatorExperiment = EmailValidatorExperiment()
                    ...
                    Surface(
                        ...
                        NavHost(navController = navController, startDestination = "main") {
                            composable("dictionary") {
                                ...
                                DictionaryScreen(dictionaryExperiment) { message ->
                                    scope.launch {
                                        snackbarHostState
                                            .showSnackbar(
                                                message = message,
                            ...
                            composable("registration") {
                                canNavigateUp.value = true
                                RegistrationScreen(emailValidatorExperiment)
                            }
                            composable("main") {
